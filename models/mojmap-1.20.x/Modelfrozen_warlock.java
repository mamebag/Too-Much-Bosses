...
public class Modelfrozen_warlock<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "frozen_warlock"), "main");
	private final ModelPart root;
	private final ModelPart UpperBody;
	private final ModelPart LeftArm;
	private final ModelPart LeftArmLower;
	private final ModelPart icepad;
	private final ModelPart Head;
	private final ModelPart hood;
	private final ModelPart hoodpart4;
	private final ModelPart hoodpart3;
	private final ModelPart hoodpart2;
	private final ModelPart hoodpart1;
	private final ModelPart Body;
	private final ModelPart RightArm;
	private final ModelPart icepad4;
	private final ModelPart icepad3;
	private final ModelPart RightArmLower;
	private final ModelPart icepad2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition UpperBody = all.addOrReplaceChild("UpperBody", CubeListBuilder.create().texOffs(74, 103)
				.addBox(-4.0F, -12.0F, -3.0F, 8.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 10.0F, 0.0F));

		PartDefinition cube_r1 = UpperBody.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(83, 22).addBox(-1.0F, -4.0F, -3.0F, 2.0F, 4.0F, 6.0F,
		...
		PartDefinition LeftArm = UpperBody.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(32, 44)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.01F)).texOffs(31, 99)
						.addBox(-1.0F, -3.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, -10.0F, 0.0F));

		PartDefinition LeftArmLower = LeftArm.addOrReplaceChild("LeftArmLower",
				CubeListBuilder.create().texOffs(31, 112)
						.addBox(-2.0F, 0.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 54)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.01F)),
				PartPose.offset(1.0F, 4.0F, 0.0F));

		PartDefinition icepad = LeftArm.addOrReplaceChild("icepad", CubeListBuilder.create().texOffs(83, 22).addBox(
				-1.0F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(-0.5F)), PartPose.offset(4.0F, -3.0F, 0.0F));

		PartDefinition cube_r2 = icepad.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(83, 21).addBox(-1.0F, -4.0F, -3.0F, 2.0F, 4.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition Head = UpperBody.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F,
				-8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-1.0F)), PartPose.offset(0.0F, -12.0F, 0.0F));

		PartDefinition hood = Head.addOrReplaceChild("hood", CubeListBuilder.create().texOffs(17, 64).addBox(-2.0F,
				-7.0F, 2.0F, 5.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 0.0F, 0.0F));

		PartDefinition hoodpart4 = hood.addOrReplaceChild("hoodpart4",
				CubeListBuilder.create().texOffs(35, 65)
						.addBox(-1.0F, -9.0F, -5.0F, 1.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(27, 73)
						.addBox(-1.0F, -9.0F, -1.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -1.0F, -1.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition hoodpart3 = hood.addOrReplaceChild("hoodpart3",
				CubeListBuilder.create().texOffs(35, 65)
						.addBox(-1.0F, -9.0F, -5.0F, 2.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(27, 73)
		...
		PartDefinition Body = UpperBody.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 16)
						.addBox(-4.0F, -8.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(-0.01F)).texOffs(45, 54)
						.addBox(-1.0F, -1.0F, -3.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F)).texOffs(45, 54)
						.addBox(-1.0F, -4.0F, -3.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F)).texOffs(45, 54)
						.addBox(-1.0F, -7.0F, -3.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition RightArm = UpperBody.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(40, 16)
				.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.01F)),
				PartPose.offset(-5.0F, -10.0F, 0.0F));

		PartDefinition cube_r3 = RightArm
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(2, 99).addBox(-1.0F, -3.0F, -3.0F, 5.0F, 7.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition icepad4 = RightArm.addOrReplaceChild("icepad4",
				CubeListBuilder.create().texOffs(71, 57)
						.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(-0.5F)).texOffs(108, 70)
						.addBox(-1.0F, -4.0F, 1.0F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -3.0F, 3.0F, -1.5708F, -1.5272F, 1.5708F));

		PartDefinition cube_r4 = icepad4
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(108, 70).addBox(-1.0F, -8.0F, 1.0F, 6.0F, 5.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(3.0F, 4.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r5 = icepad4.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(71, 57).addBox(-1.0F, -4.0F, -3.0F, 2.0F, 4.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition icepad3 = RightArm.addOrReplaceChild("icepad3",
				CubeListBuilder.create().texOffs(83, 23).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(-4.0F, 1.0F, -3.0F, 0.0F, 1.5708F, -1.5708F));

		PartDefinition cube_r6 = icepad3.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(83, 23).addBox(-1.0F, -3.0F, -3.0F, 2.0F, 3.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition RightArmLower = RightArm.addOrReplaceChild("RightArmLower", CubeListBuilder.create()
				.texOffs(40, 26).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.01F)),
				PartPose.offset(-1.0F, 4.0F, 0.0F));

		PartDefinition cube_r7 = RightArmLower
				.addOrReplaceChild("cube_r7",
						CubeListBuilder.create().texOffs(2, 112).addBox(-1.0F, -3.0F, -3.0F, 5.0F, 7.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.0F, 3.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition icepad2 = RightArmLower.addOrReplaceChild("icepad2",
				CubeListBuilder.create().texOffs(83, 21).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(-3.0F, 2.0F, 3.0F, 0.0F, -1.5708F, -1.5708F));

		PartDefinition cube_r8 = icepad2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(83, 23).addBox(-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
