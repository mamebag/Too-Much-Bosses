...
public class ModelTheBoss<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "theboss"), "main");
	...
	private final ModelPart commandBlockRight;
	private final ModelPart leftArm;
	private final ModelPart commandBlockLeft;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition commandBlockRight = rightArm.addOrReplaceChild("commandBlockRight", CubeListBuilder.create().texOffs(40, 20).addBox(-9.0F, 0.0F, -9.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition commandBlockLeft = leftArm.addOrReplaceChild("commandBlockLeft", CubeListBuilder.create().texOffs(40, 20).addBox(-10.0F, -1.0F, -9.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 9.0F, 0.0F, -0.9163F, 0.0F, 0.0F));
