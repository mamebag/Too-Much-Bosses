...
public class ModelBipedSample<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bipedsample"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition upperBody = body.addOrReplaceChild("upperBody", CubeListBuilder.create().texOffs(16, 16)
		...
		PartDefinition rightArm_r1 = rightArm.addOrReplaceChild("rightArm_r1",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-9.0F, -24.0F, -1.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25)
						.addBox(-9.0F, -20.0F, -1.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightArm2 = rightArm_r1.addOrReplaceChild("rightArm2",
				CubeListBuilder.create().texOffs(40, 24)
						.addBox(-2.0F, 2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 26)
		...
		PartDefinition rightLeg = body.addOrReplaceChild("rightLeg", CubeListBuilder.create().texOffs(0, 16).addBox(
				-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition rightleg2 = rightLeg.addOrReplaceChild("rightleg2", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-1.9F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.1F, 6.0F, 0.0F));

		PartDefinition leftLeg = body.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F,
				0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.1F, 12.0F, 0.0F));

		PartDefinition leftLeg2 = leftLeg.addOrReplaceChild("leftLeg2", CubeListBuilder.create().texOffs(0, 16).addBox(
				-1.9F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.1F, 6.0F, 0.0F));
