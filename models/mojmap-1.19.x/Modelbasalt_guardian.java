...
public class Modelbasalt_guardian<T extends Entity> extends HierarchicalModel<T>{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "basalt_guardian"), "main");
	private final ModelPart root;
	private final ModelPart zouhanshin;
	private final ModelPart head;
	private final ModelPart rightArm;
	private final ModelPart rightarmFist;
	private final ModelPart rightarmAlmost;
	private final ModelPart leftArm;
	private final ModelPart rightArm2;
	private final ModelPart leftArmFist;
	private final ModelPart leftarmAlmost;
	...
	public Modelbasalt_guardian(ModelPart root) {
		...
		PartDefinition cube_r7_r1 = arm.addOrReplaceChild("cube_r7_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -5.0F, -14.0F, 9.0F, 9.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r1 = rightarmpad.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(131, 75).addBox(-2.0F, -4.0F, -6.0F, 4.0F, 12.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -7.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r2 = rightarmpad.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(95, 21).addBox(6.0F, -12.0F, -1.0F, 0.0F, 6.0F, 14.0F, new CubeDeformation(0.0F))
		.texOffs(95, 21).addBox(-9.0F, -11.0F, -1.0F, 0.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r3 = rightarmpad.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(95, 13).addBox(-13.0F, -12.0F, -9.0F, 0.0F, 6.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition netherwart = rightarmpad.addOrReplaceChild("netherwart", CubeListBuilder.create().texOffs(114, 102).addBox(2.0F, -5.0F, -1.0F, 10.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -4.0F, 1.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r4 = netherwart.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(113, 102).addBox(-1.0F, -1.0F, -6.0F, 11.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -2.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition netherwart2 = netherwart.addOrReplaceChild("netherwart2", CubeListBuilder.create().texOffs(114, 102).addBox(-6.0F, 0.0F, -2.0F, 10.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 1.0F, 1.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r5 = netherwart2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(113, 102).addBox(-1.0F, -1.0F, -6.0F, 11.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 3.0F, -1.0F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = obi_02.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(178, 59).addBox(-3.0F, -27.0F, 10.0F, 5.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.0F, 28.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r7_r2 = arm2.addOrReplaceChild("cube_r7_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -5.0F, -14.0F, 9.0F, 9.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = rightarmpad2.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(109, 1).addBox(-2.0F, -4.0F, -6.0F, 4.0F, 12.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -7.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r8 = rightarmpad2.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(95, 21).addBox(6.0F, -12.0F, -1.0F, 0.0F, 6.0F, 14.0F, new CubeDeformation(0.0F))
		.texOffs(95, 21).addBox(-9.0F, -11.0F, -1.0F, 0.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r9 = rightarmpad2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(95, 13).addBox(-13.0F, -12.0F, -9.0F, 0.0F, 6.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r10 = obi_3.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(178, 59).addBox(-3.0F, -27.0F, 10.0F, 5.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.0F, 28.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(78, 79).addBox(-5.0F, -46.0F, -3.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 40.0F, 3.0F, -0.0436F, 0.0F, 0.0F));
		...
		PartDefinition mainbody = body.addOrReplaceChild("mainbody", CubeListBuilder.create().texOffs(54, 0).addBox(-10.0F, -16.0F, -4.0F, 20.0F, 5.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(53, 45).addBox(-12.0F, -36.0F, -6.0F, 24.0F, 20.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = plants_on_body.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(199, 30).addBox(-4.0F, -3.0F, 0.0F, 8.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -37.0F, 1.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition cube_r12 = plants_on_body2.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(199, 30).addBox(-4.0F, -6.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -37.0F, 1.0F, 0.0F, -1.5708F, 0.0F));
