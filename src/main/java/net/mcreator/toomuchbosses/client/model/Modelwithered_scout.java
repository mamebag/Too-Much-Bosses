...
public class Modelwithered_scout<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("too_much_bosses", "modelwithered_scout"), "main");
	public final ModelPart all;
	public final ModelPart Head;
	public final ModelPart zyouhanshin;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightArm_armor = RightArm.addOrReplaceChild("rightArm_armor",
				CubeListBuilder.create().texOffs(78, 64).addBox(-3.0F, -2.5F, -2.0F, 4.0F, 4.5F, 4.0F, new CubeDeformation(0.0F)).texOffs(78, 75).addBox(-1.5F, 3.0F, -2.0F, 2.5F, 7.0F, 3.5F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition sword = RightArm.addOrReplaceChild("sword", CubeListBuilder.create(), PartPose.offset(0.0F, 9.0F, 0.0F));
		PartDefinition blade = sword.addOrReplaceChild("blade",
				CubeListBuilder.create().texOffs(87, 95).addBox(-1.0F, -2.13F, -16.0F, 1.0F, 2.13F, 10.0F, new CubeDeformation(0.0F)).texOffs(97, 109).addBox(-1.0F, -2.13F, -16.6F, 1.0F, 1.13F, 0.72F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 1.0F));
		PartDefinition cube_r1 = blade.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(95, 107).addBox(-1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -16.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r2 = blade.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(103, 92).addBox(-1.5F, -5.9F, -4.48F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition tuka = sword.addOrReplaceChild("tuka", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -12.0F));
		PartDefinition cube_r3 = tuka.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(106, 48).addBox(-1.0F, 7.0F, 7.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 46).addBox(-1.0F, 8.0F, 8.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 48)
						.addBox(-1.0F, 9.0F, 10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 48).addBox(-1.0F, 9.0F, 9.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 46)
						.addBox(-1.0F, 6.0F, 7.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 48).addBox(-1.0F, 7.0F, 6.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 48)
						.addBox(-1.0F, 8.0F, 7.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 48).addBox(-1.0F, 9.0F, 8.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 48)
						.addBox(-1.0F, 10.0F, 9.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 52).addBox(-1.0F, 11.0F, 11.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 50)
						.addBox(-1.0F, 10.0F, 10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(102, 50).addBox(-1.0F, 11.0F, 10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(106, 50)
						.addBox(-1.0F, 10.0F, 11.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm_armor = LeftArm.addOrReplaceChild("leftArm_armor",
				CubeListBuilder.create().texOffs(78, 64).addBox(-3.0F, -2.5F, -2.0F, 4.0F, 4.5F, 4.0F, new CubeDeformation(0.0F)).texOffs(78, 75).addBox(-1.5F, 3.0F, -2.0F, 2.5F, 7.0F, 3.5F, new CubeDeformation(0.0F)),
		...
		PartDefinition chestplate = Body.addOrReplaceChild("chestplate",
				CubeListBuilder.create().texOffs(22, 57).addBox(-5.0F, 0.0F, -3.0F, 10.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(22, 79).addBox(-5.0F, 7.0F, -2.0F, 10.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition rightLeg_armor = RightLeg.addOrReplaceChild("rightLeg_armor", CubeListBuilder.create().texOffs(75, 38).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg_armor = LeftLeg.addOrReplaceChild("LeftLeg_armor", CubeListBuilder.create().texOffs(75, 38).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 3.1416F, 0.0F, 3.0543F));
