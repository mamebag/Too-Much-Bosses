...
//import net.mcreator.toomuchbosses.procedures.PakuriRightClickedOnEntityProcedure;
import net.mcreator.toomuchbosses.init.TooMuchBossesModEntities;
import net.minecraft.world.entity.ai.behavior.warden.Roar;

public class PakuriEntity extends Monster {
public final AnimationState roarAnimationState = new AnimationState();
	...
	public PakuriEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TooMuchBossesModEntities.PAKURI.get(), world);
	}

	public PakuriEntity(EntityType<PakuriEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		//PakuriRightClickedOnEntityProcedure.execute(entity);
		return retval;
	}
