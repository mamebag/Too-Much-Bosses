...
import net.mcreator.toomuchbosses.procedures.IceProjectileWhileProjectileFlyingTickProcedure;
import net.mcreator.toomuchbosses.procedures.IceProjectileProjectileHitsBlockProcedure;
...
public class IceProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public IceProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TooMuchBossesModEntities.ICE_PROJECTILE.get(), world);
	}
	...
	public void playerTouch(Player entity) {
		...
		IceProjectileProjectileHitsBlockProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		//IceProjectileProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ(), this);
	}

	@Override
	public void tick() {
		super.tick();
		IceProjectileWhileProjectileFlyingTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this.getOwner(), this);
		/*if (this.inGround)
			this.discard();*/
	}
	...
	public static IceProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IceProjectileEntity entityarrow = new IceProjectileEntity(TooMuchBossesModEntities.ICE_PROJECTILE.get(), entity, world);
	...
	public static IceProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		IceProjectileEntity entityarrow = new IceProjectileEntity(TooMuchBossesModEntities.ICE_PROJECTILE.get(), entity, entity.level());
